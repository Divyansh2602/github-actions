...
| | |
|---|---|
| **3D skyline** | <img src="profile-3d-contrib/profile-cyberpunk.svg" width="420" alt="Isometric 3D contribution graph" /> |
| **Contribution radar** | <img src="profile-3d-contrib/profile-radar.svg" width="420" alt="Contribution radar chart" /> |
| **Language mix** | <img src="profile-3d-contrib/profile-languages.svg" width="420" alt="Language breakdown pie chart" /> |
...
|---|---|---|
| [`3d-contrib.yml`](.github/workflows/3d-contrib.yml) | daily, 00:10 UTC | Renders the 3D skyline, radar, and language pie, commits them to `main` |
...
- Palette lives in [`conf/3d-contrib-settings.json`](conf/3d-contrib-settings.json);
  the file is an array, so each entry renders one more SVG variant.
